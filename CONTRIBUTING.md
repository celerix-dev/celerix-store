...
2. **Lint your code:** Ensure your code follows the project's style.
3. **Description:** Explain what your PR does and why it's a good fit for Celerix Store.

## ⚖️ License
By contributing to Celerix Store, you agree that your contributions will be licensed under the **MIT License**.
